...
class QuizGameDetails extends Component {
  ...
  showAnswers = (question, answers, index) => {
    ...
    return answers.map(answer => {
      ...
      if (answer === question.correct_answer && chosenAnswer === answer)
        rowStyle = 'green accent-4';
      if (answer !== question.correct_answer) rowStyle = 'purple darken-3';
      if (answer !== question.correct_answer && chosenAnswer === answer)
        rowStyle = 'red darken-3';
      ...
      <div>
        ...
        <table className="blue history">
          <thead className="blue">
            ...
            <tr>
              <th>
                Date played: <b>{getFullDate(this.state.game.date.seconds)}</b>
              </th>
            </tr>
            <tr>
              <th>
                Category: <b>{this.state.game.options.category}</b>
              </th>
            </tr>
            <tr>
              <th>
                Difficulty: <b>{this.state.game.options.difficulty}</b>
              </th>
            </tr>
            <tr>
              <th>
